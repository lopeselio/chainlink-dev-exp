...
| Live dashboard | https://chainlink-cre-snapshot.vercel.app |
...
**Live:** https://chainlink-cre-snapshot.vercel.app · run locally with `cd frontend && bun install && bun run dev`.
